...
public class Time {
    ...
    /**
     * Takes two dates as strings and calculates the length of
     * the interval between them as days.
     * 
    ...
    /**
     * Gets the corresponding number associated with the weekday
     * of the input date. Week starts on Monday. 
     * Days are numbered from 1-7 (Mon - Sun).
     * 
    ...
    /**
     * Gets the corresponding number associated with the current weekday. 
     * Week starts on Monday. Days are numbered from 1-7 (Mon - Sun).
     * 
